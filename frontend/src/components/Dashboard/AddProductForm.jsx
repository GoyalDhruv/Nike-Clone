...
import { deleteFile, uploadFile } from '../../services/productApi';
import { FieldArray } from 'formik';
import { MdDelete } from 'react-icons/md';
import { TbCloudUpload } from 'react-icons/tb';

function AddProductForm({ id, values, errors, touched, handleChange, setFieldValue, handleSubmit, handleReset }) {
    ...
    return (
        <form onSubmit={handleSubmit} className="py-10">
                            ...
                            <div>
                                {values.variants.map((_, index) => (
                                    <div key={index} className="grid grid-cols-12 border p-4 mb-4 rounded-lg mt-2">
                                        ...
                                        {values.category && <div className='xl:col-span-4 lg:col-span-6 col-span-12'>
                                        ...
                                        <div className='col-span-12'>
                                            ...
                                            <FieldArray
                                                ...
                                                render={imgHelpers => (
                                                    <>
                                                        <div className='grid xl:grid-cols-4 lg:grid-cols-3 sm:grid-cols-1 gap-3'>
            ...
            <div className='flex gap-3 justify-end mt-4'>
                ...
                <button type="submit" className='black-btn mt-3 px-5'>{id ? "Edit" : "Add"} Product</button>
            </div>
        </form>
    )
}
